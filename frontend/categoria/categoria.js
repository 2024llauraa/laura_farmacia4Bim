...
async function buscarCategoria() {
    ...
    try {
        ...
        if (response.ok) {
            ...
            mostrarMensagem('Categoria não encontrado. Você pode incluir uma novo categoria.', 'info');
...
async function salvarOperacao() {
    ...
    try {
        ...
        if (response.ok && (operacao === 'incluir' || operacao === 'alterar')) {
            ...
            mostrarMensagem('Categoria excluído com sucesso!', 'success');
            limparFormulario();
            carregarCategorias();
        }
    } catch (error) {
        console.error('Erro:', error);
        mostrarMensagem('Erro ao incluir ou alterar o categoria', 'error');
    }
